								...
								<div class="block block-minicart">
									<div class="minicart-content-wrapper">
										...
										<div class="block-content">
											...
											<div class="actions">
												<div class="secondary">
													<a href="<?php echo base_url()?>cart" class="btn btn-alt">
														<i class="icon icon-cart"></i><span>Ver y editar carrito</span>
													</a>
												</div>
												<div class="primary">
													<a class="btn" href="<?php echo base_url() ?>checkout">
														<i class="icon icon-external-link"></i><span>Realizar pago</span>
													</a>
												</div>
											</div>
										</div>
