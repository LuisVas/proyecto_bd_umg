...
sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrando 0 a 0 de 0 resultados",sInfoFiltered:"(Filtrado de _MAX_ resultados totales )",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrando _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
...
sJUIHeader:"",sJUIFooter:""});var Ob=q.ext.pager;f.extend(Ob,{simple:function(a,b){return["anterior","siguiente"]},full:function(a,b){return["primero","anterior","siguiente","último"]},numbers:function(a,b){return[ja(a,b)]},simple_numbers:function(a,b){return["previous",ja(a,b),"next"]},full_numbers:function(a,b){return["first","anterior",ja(a,b),"siguiente","last"]},first_last_numbers:function(a,b){return["first",ja(a,b),"last"]},_numbers:ja,numbers_length:7});f.extend(!0,q.ext.renderer,{pageButton:{_:function(a,b,
